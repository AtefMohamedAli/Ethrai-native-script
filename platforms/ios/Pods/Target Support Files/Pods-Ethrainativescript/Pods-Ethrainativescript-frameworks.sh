...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DRCircularProgress/DRCircularProgress.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/iOS-QR-Code-Generator/iOS_QR_Code_Generator.framework"
